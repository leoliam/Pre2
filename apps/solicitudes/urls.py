...
urlpatterns = patterns('',			
	...
	url(r'^create-resultado/$', 'apps.solicitudes.views.CreateResultado' , name='createResultado'),
	url(r'^buscar-resultado/$', 'apps.solicitudes.views.BuscarResultado' , name='buscarResultado'),
	url(r'^modi-resultado/$', 'apps.solicitudes.views.ModiResultado' , name='modiResultado'),
	url(r'^HomeReporteSolicitud/$', 'apps.solicitudes.views.HomeReporteSolicitud' , name='ReporteSolicitud'),
	url(r'^crear/reporte/(?P<fecha>[^/]+)/(?P<area>[^/]+)/(?P<id>[^/]+)/$', 'apps.solicitudes.views.crear_reporte_solicitud', name='ReporteSolicitudFecha'),
)
